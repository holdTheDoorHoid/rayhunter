...
9. **`imsi_requested` real-world validation:** is there a known real capture this heuristic has been exercised against? *Docs status: `detectors/imsi-requested.md` states "real-capture status not established here" and carries a `NEEDS INPUT` marker asking for a reference capture. Still needs your answer.*
